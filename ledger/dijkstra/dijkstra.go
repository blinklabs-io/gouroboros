...
// non-empty credential-keyed map of optional Plutus datums that transaction
// bodies require the top-level guard set to satisfy.
...
// called from each containing transaction body's MarshalCBOR before wire
// encoding.
