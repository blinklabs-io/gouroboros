...
type MockLedgerState struct {
	...
	CommitteeMemberFunc  func(common.Blake2b224) (*common.CommitteeMember, error)
	DRepRegistrationFunc func(common.Blake2b224) (*common.DRepRegistration, error)
}
...
func (m *MockLedgerState) CommitteeMember(
	...
	if m.CommitteeMemberFunc != nil {
		return m.CommitteeMemberFunc(coldKey)
	}
...
func (m *MockLedgerState) DRepRegistration(
	...
	if m.DRepRegistrationFunc != nil {
		return m.DRepRegistrationFunc(credential)
	}
