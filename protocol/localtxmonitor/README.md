...
|---------|---------|-----------|-------------|
| `Acquire` | 0 | Client → Server | Acquire mempool snapshot |
| `Acquired` | 1 | Server → Client | Snapshot acquired with slot number |
| `Release` | 2 | Client → Server | Release snapshot |
| `HasTx` | 3 | Client → Server | Check if tx is in mempool |
| `ReplyHasTx` | 4 | Server → Client | HasTx result (bool) |
| `NextTx` | 5 | Client → Server | Get next transaction |
| `ReplyNextTx` | 6 | Server → Client | Next transaction or empty |
| `GetSizes` | 7 | Client → Server | Get mempool sizes |
| `ReplyGetSizes` | 8 | Server → Client | Mempool size information |
