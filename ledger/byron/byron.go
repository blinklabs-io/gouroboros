...
func (p *ByronUpdateProposal) UnmarshalCBOR(cborData []byte) error {
	...
	fields, err := byronArrayFields(cborData, "byron update proposal")
	if err != nil {
		return err
	}
	...
	signature, err := decodeByronByteString(fields[6], false)
...
func (b *ByronMainBlockBody) UnmarshalCBOR(cborData []byte) error {
	...
	if err := validateUpdateVotesWire(rawParts[3]); err != nil {
		return err
	}
