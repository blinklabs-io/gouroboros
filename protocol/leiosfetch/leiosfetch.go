...
type (
	BlockRequestFunc      func(CallbackContext) (protocol.Message, error)
	BlockTxsRequestFunc   func(CallbackContext) (protocol.Message, error)
	VotesRequestFunc      func(CallbackContext) (protocol.Message, error)
	BlockRangeRequestFunc func(CallbackContext) (protocol.Message, error)
)
