...
// TestBabbageUtxorpc_MandatoryRatFieldNilEmbeddedRatRejectedNotPanic is the
...
func TestBabbageUtxorpc_MandatoryRatFieldNilEmbeddedRatRejectedNotPanic(
	t *testing.T,
) {
	validBase := func() babbage.BabbageProtocolParameters {
	...
	tests := []struct {
		name   string
		mutate func(*babbage.BabbageProtocolParameters)
	}{
		{"A0", func(p *babbage.BabbageProtocolParameters) {
			p.A0 = &cbor.Rat{}
		}},
		{"Rho", func(p *babbage.BabbageProtocolParameters) {
			p.Rho = &cbor.Rat{}
		}},
		{"Tau", func(p *babbage.BabbageProtocolParameters) {
			p.Tau = &cbor.Rat{}
		}},
		{"memory price", func(p *babbage.BabbageProtocolParameters) {
			p.ExecutionCosts.MemPrice = &cbor.Rat{}
		}},
		{"step price", func(p *babbage.BabbageProtocolParameters) {
...
// TestBabbageUtxorpc_ValueBeyondInt64RangeRejected is the regression test
...
func TestBabbageUtxorpc_ValueBeyondInt64RangeRejected(t *testing.T) {
