...
type Pipeline interface {
	...
	Submit(blockType uint, rawCbor []byte, tip pcommon.Tip) error
...
type PipelineStats struct {
	...
	// DecodeLatency contains latency percentiles for the decode stage.
	DecodeLatency LatencyStats
	// ValidateLatency contains latency percentiles for the validate stage.
	ValidateLatency LatencyStats
	// ApplyLatency contains latency percentiles for the apply stage.
	ApplyLatency LatencyStats

	// PipelineLatency contains end-to-end latency percentiles.
