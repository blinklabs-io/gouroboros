...
func TestUtxoValidateInputSetEmptyUtxo(t *testing.T) {
	...
	t.Run(
		"non-empty input set",
		func(t *testing.T) {
			err := allegra.UtxoValidateInputSetEmptyUtxo(
				testTx,
				testSlot,
				testLedgerState,
				testProtocolParams,
...
func TestUtxoValidateWrongNetworkWithdrawal(t *testing.T) {
	...
	t.Run(
		...
		func(t *testing.T) {
			...
			err := allegra.UtxoValidateWrongNetworkWithdrawal(
				testTx,
				testSlot,
				testLedgerState,
				testProtocolParams,
...
func TestUtxoValidateOutputBootAddrAttrsTooBig(t *testing.T) {
	...
	t.Run(
		...
		func(t *testing.T) {
			...
			err := allegra.UtxoValidateOutputBootAddrAttrsTooBig(
				testTx,
				testSlot,
				testLedgerState,
				testProtocolParams,
...
func TestUtxoValidateMaxTxSizeUtxo(t *testing.T) {
	...
	t.Run(
		...
		func(t *testing.T) {
			...
			err := allegra.UtxoValidateMaxTxSizeUtxo(
				testTx,
				testSlot,
				testLedgerState,
				testProtocolParams,
