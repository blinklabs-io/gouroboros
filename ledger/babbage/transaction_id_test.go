...
func TestBabbageTransactionBodyIdConcurrentFirstCall(t *testing.T) {
...
func TestBabbageTransactionBodyIdSetCborInvalidatesOnlyCopy(t *testing.T) {
	var body babbage.BabbageTransactionBody
	body.SetCbor([]byte{0xa0})
	wantOriginal := body.Id()

	for name, setCbor := range map[string]func(*babbage.BabbageTransactionBody, []byte){
		"SetCbor":          (*babbage.BabbageTransactionBody).SetCbor,
		"SetCborReference": (*babbage.BabbageTransactionBody).SetCborReference,
	} {
