...
This release hardens handling for field reported issues.

### Bug Fixes

* Fixed field reported issue handling so the library behaves more reliably when those cases appear.
